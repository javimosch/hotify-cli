...
func printHelp() {
	...
	fmt.Println()
	fmt.Println("Traefik System Commands:")
	fmt.Println("  hotify-cli traefik-system [--json] [--target <name>]")
	fmt.Println("  hotify-cli traefik-system --status [--json] [--target <name>]")
	fmt.Println("  hotify-cli traefik-system --remove [--json] [--target <name>]")
	fmt.Println("  hotify-cli traefik-system --force [--json] [--target <name>]")
	fmt.Println()
